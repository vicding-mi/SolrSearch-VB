...
class SolrSearch_Form_Results extends Omeka_Form
{
    ...
    public function init()
    {
        ...
        $this->addElement('textarea', 'solr_search_display_facets_order', array(
            'label'         => __('Display facets order'),
            'description'   => __('The order of facets to display (internal id code). Facets that are not mentioned here are not shown. Facets that are mentioned here MUST be added as facet in Fields setting.'),
            'value'         => get_option('solr_search_display_facets_order'),
            'required'      => false,
            'rows'          => 12
        ));
